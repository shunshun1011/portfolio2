  ...
  <section class="text-tertiary-600 body-font relative">
    <div class="container px-5 md:py-16 py-8 mx-auto">
      <div class="flex flex-wrap w-full">
        <div class="w-full mb-6">
          <h1
            class="sm:text-3xl text-2xl title-font font-bold mb-2 text-tertiary-900 text-center"
          >
            Access & Contact
          </h1>
    ...
    <div class="container px-5 pb-24 mx-auto flex sm:flex-nowrap flex-wrap">
      ...
      >
        ...
        ></iframe>
        <div
          class="bg-secondary-50 relative flex flex-wrap py-6 rounded shadow-md"
        >
          <div class="lg:w-1/2 px-6">
            <h2
              class="title-font font-semibold text-tertiary-900 tracking-widest text-xs"
            >
              ADDRESS
            </h2>
          ...
          <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
            ...
            <h2
              class="title-font font-semibold text-tertiary-900 tracking-widest text-xs mt-4"
            >
              PHONE
            </h2>
      ...
      >
        ...
        <div class="relative mb-4">
          <label for="name" class="leading-7 text-sm text-tertiary-600"
            >Name</label
          >
          <input
            type="text"
        ...
        <div class="relative mb-4">
          <label for="email" class="leading-7 text-sm text-tertiary-600"
            >Email</label
          >
          <input
            type="email"
        ...
        <div class="relative mb-4">
          <label for="message" class="leading-7 text-sm text-tertiary-600"
            >Message</label
          >
          <textarea
            id="message"
            ...
            v-model="message"
            required
            class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-tertiary-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
          ></textarea>
        ...
        <button
          type="submit"
          class="text-white bg-secondary-500 border-0 py-2 px-6 focus:outline-none hover:bg-secondary-600 rounded text-lg"
        >
          Send
        </button>
